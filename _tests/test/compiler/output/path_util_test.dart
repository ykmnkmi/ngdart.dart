  ...
  group('PathUtils getImportModulePath', () {
    ...
    test('should calculate absolute paths', () {
      expect(
        getImportModulePath(
          'asset:somePkg/lib/modPath',
          'asset:someOtherPkg/lib/impPath',
        ),
    ...
    test('should not allow absolute imports of non lib modules', () {
      expect(
        ...
        throwsWith(
          "Can't import url asset:somePkg/test/impPath from "
          'asset:somePkg/lib/modPath',
        ),
      );
    });
    ...
    test(
      ...
      () {
        expect(
          getImportModulePath('asset:somePkg/lib/modPath', 'dart:html'),
          'dart:html',
        );
      },
    );
