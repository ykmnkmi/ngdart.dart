...
class Identifiers {
  ...
  static final Injector = CompileIdentifierMetadata(
    name: 'Injector',
    moduleUrl: 'asset:angular/lib/src/di/injector.dart',
  );
  ...
  static final NG_IF_DIRECTIVE = CompileIdentifierMetadata(
    name: 'NgIf',
    moduleUrl: _ngIfUrl,
  );
  static final NG_FOR_DIRECTIVE = CompileIdentifierMetadata(
    name: 'NgFor',
    moduleUrl: _ngForUrl,
  );
  ...
  static var HTML_COMMENT_NODE = CompileIdentifierMetadata(
    name: 'Comment',
    moduleUrl: 'dart:html',
  );
  static var HTML_TEXT_NODE = CompileIdentifierMetadata(
    name: 'Text',
    moduleUrl: 'dart:html',
  );
  static var HTML_DOCUMENT = CompileIdentifierMetadata(
    name: 'document',
    moduleUrl: 'dart:html',
  );
  ...
  static final HTML_ELEMENT = CompileIdentifierMetadata(
    name: 'Element',
    moduleUrl: 'dart:html',
  );
  static final ElementToken = identifierToken(HTML_ELEMENT);
  static final HTML_HTML_ELEMENT = CompileIdentifierMetadata(
    name: 'HtmlElement',
    moduleUrl: 'dart:html',
  );
  static final HtmlElementToken = identifierToken(HTML_HTML_ELEMENT);
  static final SVG_SVG_ELEMENT = CompileIdentifierMetadata(
    name: 'SvgSvgElement',
    moduleUrl: 'dart:svg',
  );
  static final SVG_ELEMENT = CompileIdentifierMetadata(
    name: 'SvgElement',
    moduleUrl: 'dart:svg',
  );
  static final HTML_ANCHOR_ELEMENT = CompileIdentifierMetadata(
    name: 'AnchorElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_DIV_ELEMENT = CompileIdentifierMetadata(
    name: 'DivElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_AREA_ELEMENT = CompileIdentifierMetadata(
    name: 'AreaElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_AUDIO_ELEMENT = CompileIdentifierMetadata(
    name: 'AudioElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_BUTTON_ELEMENT = CompileIdentifierMetadata(
    name: 'ButtonElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_CANVAS_ELEMENT = CompileIdentifierMetadata(
    name: 'CanvasElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_FORM_ELEMENT = CompileIdentifierMetadata(
    name: 'FormElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_IFRAME_ELEMENT = CompileIdentifierMetadata(
    name: 'IFrameElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_IMAGE_ELEMENT = CompileIdentifierMetadata(
    name: 'ImageElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_INPUT_ELEMENT = CompileIdentifierMetadata(
    name: 'InputElement',
    moduleUrl: 'dart:html',
  );
  ...
  static final HTML_MEDIA_ELEMENT = CompileIdentifierMetadata(
    name: 'MediaElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_MENU_ELEMENT = CompileIdentifierMetadata(
    name: 'MenuElement',
    moduleUrl: 'dart:html',
  );
  ...
  static final HTML_OPTION_ELEMENT = CompileIdentifierMetadata(
    name: 'OptionElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_OLIST_ELEMENT = CompileIdentifierMetadata(
    name: 'OListElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_SELECT_ELEMENT = CompileIdentifierMetadata(
    name: 'SelectElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_TABLE_ELEMENT = CompileIdentifierMetadata(
    name: 'TableElement',
    moduleUrl: 'dart:html',
  );
  ...
  static final HTML_ULIST_ELEMENT = CompileIdentifierMetadata(
    name: 'UListElement',
    moduleUrl: 'dart:html',
  );
  static final HTML_NODE = CompileIdentifierMetadata(
    name: 'Node',
    moduleUrl: 'dart:html',
  );
